    ...
    return <header>
        ...
        <div className="app-container md:flex justify-center text-neutral-700 my-2 hidden text-[15px]">
            <ul className="flex justify-center items-center gap-8">
                ...
                <li>
                    <Link to="/" className="flex items-center justify-center gap-1 item-hover relative">
                        ...
                        <ul className="absolute top-full left-0 bg-white py-2 shadow-lg w-[200px] text-neutral-600 z-10 text-sm opacity-0 pointer-events-none item-child-hover">
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/adidas">Adidas</Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover" to="/collections/nike">
                                    ...
                                    <ul className="item-child-hover absolute top-0 left-full w-[200px] bg-white z-10 py-2 shadow-lg">
                                        <li>
                                            <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/af1">AF1</Link>
                                        </li>
                                        <li>
                                            <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/jordan">Jordan</Link>
                                        </li>
                                        <li>
                                            <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/blazer">Blazer</Link>
                                        </li>
                                    </ul>
                                </Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/ascis-puma">Ascis - Puma</Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/mlb">MLB</Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/croon">CROON</Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/new-balance-fila">New Balance - Fila</Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/luxury">Luxury</Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/converse-vans">Converse - Vans</Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/chinh-hang">Chính hãng</Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/all">
                                    <span className="flex-1">Phụ kiện</span>
                                    <ChevronRightIcon className="w-3 ml-1"/>
                                    <ul className="item-child-hover absolute top-0 left-full w-[200px] bg-white z-10 py-2 shadow-lg">
                                        <li>
                                            <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/vo">Vớ</Link>
                                        </li>
                                        <li>
                                            <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/non">Nón</Link>
                                        </li>
                                        <li>
                                            <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/mat-kinh">Mắt kính</Link>
                                        </li>
                                        <li>
                                            <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/dep">Dép</Link>
                                        </li>
                                        <li>
                                            <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/collections/khac">Khác</Link>
                                        </li>
                                    </ul>
                                </Link>
                            </li>
                ...
                <li>
                    <Link to="/collections/mua-1-tang-1" className="hover:text-neutral-900">Hàng mới về</Link>
                </li>
                <li>
                ...
                <li>
                    <Link to="/pages/chinh-sach-doi-tra-1" className="flex items-center justify-center gap-1 item-hover relative">
                        ...
                        <ul className="absolute top-full left-0 bg-white py-2 shadow-lg w-[200px] text-neutral-600 z-10 text-sm opacity-0 pointer-events-none item-child-hover">
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/pages/quy-cho-hoat-dong">Quy chế hoạt động</Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/pages/quy-tring-dat-hang-va-thanh-toan">Chính sách đặt hàng và thanh toán</Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/pages/chinh-sach-doi-tra-1">Chính sách đổi trả và bảo hành</Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/pages/chinh-sach-van-chuyen-giao-hang">Chính sách vận chuyển giao hàng</Link>
                            </li>
                            <li>
                                <Link className="px-5 py-2 flex items-center relative item-hover hover:text-neutral-700" to="/pages/chinh-sach-bao-mat-thong-tin">Chính sách bảo mật thông tin</Link>
                            </li>
                        </ul>
                    </Link>
                </li>
