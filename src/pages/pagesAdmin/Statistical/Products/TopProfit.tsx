...
const ProductsProfit = () => {
    ...
    return (
        <div>
            <h1 className='text-[26px] uppercase font-semibold ml-6'>Top 5 sản phẩm có lợi nhuận cao nhất</h1>
            <TopProfitTable products={products} />
        </div>
    );
};
