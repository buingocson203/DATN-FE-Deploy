...
import BestSellingProducts from '../Statistical/Products/ProductStatistical';
import HighestRevenueProducts from '../Statistical/Products/TopRevenue';
import HighestProfitProducts from '../Statistical/Products/TopProfit';
import instance from '@/core/api';
type Props = {}

type Category = 'bestSelling' | 'highestRevenue' | 'highestProfit'
const fetchProducts = async (selectedCategory: Category, filterBy: string, year: string, month: string, week: string) => {
    const endpointMap = {
...
const Dashboard = (props: Props) => {
    ...
    const handleTimeFrameChange = (event: { target: { value: React.SetStateAction<string>; }; }) => {
